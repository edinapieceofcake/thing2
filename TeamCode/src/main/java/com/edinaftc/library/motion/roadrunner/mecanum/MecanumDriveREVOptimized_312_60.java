...
import static com.edinaftc.library.motion.roadrunner.mecanum.DriveConstants_312_60.MOTOR_VELO_PID;
import static com.edinaftc.library.motion.roadrunner.mecanum.DriveConstants_312_60.RUN_USING_ENCODER;
import static com.edinaftc.library.motion.roadrunner.mecanum.DriveConstants_312_60.encoderTicksToInches;

/*
 * Optimized mecanum drive implementation for REV ExHs. The time savings may significantly improve
 * trajectory following performance with moderate additional complexity.
 */
public class MecanumDriveREVOptimized_312_60 extends MecanumDriveBase_312_60 {
    ...
    public MecanumDriveREVOptimized_312_60(HardwareMap hardwareMap) {
        super();
    ...
    public void setPIDCoefficients(DcMotor.RunMode runMode, PIDCoefficients coefficients) {
        for (ExpansionHubMotor motor : motors) {
            motor.setPIDFCoefficients(runMode, new PIDFCoefficients(
                    coefficients.kP, coefficients.kI, coefficients.kD, DriveConstants_312_60.getMotorVelocityF()
            ));
        }
    }
