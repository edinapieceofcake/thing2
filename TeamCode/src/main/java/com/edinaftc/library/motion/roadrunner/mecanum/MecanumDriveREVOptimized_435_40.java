 ...
 */
public class MecanumDriveREVOptimized_435_40 extends MecanumDriveBase_435_40 {
    ...
    public MecanumDriveREVOptimized_435_40(HardwareMap hardwareMap) {
        super();
        ...
        if (RUN_USING_ENCODER && DriveConstants_435_40.MOTOR_VELO_PID != null) {
    ...
    public void setPIDCoefficients(DcMotor.RunMode runMode, PIDCoefficients coefficients) {
        for (ExpansionHubMotor motor : motors) {
            motor.setPIDFCoefficients(runMode, new PIDFCoefficients(
                    coefficients.kP, coefficients.kI, coefficients.kD, DriveConstants_435_40.getMotorVelocityF()
            ));
        }
    }
