...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_X_DISTANCE = 2.75; // in; distance towards the front of the left and right wheels

//    public static double CENTER_Y_OFFSET = 3; // in; offset of the lateral wheel from center
//    public static double CENTER_X_OFFSET = -6.625; // in; offset

    public static double CENTER_Y_OFFSET = 3.25; // in; offset of the lateral wheel from center
    public static double CENTER_X_OFFSET = -6.625; // in; offset
//    public static double CENTER_X_OFFSET = -6.875; // in; offset
